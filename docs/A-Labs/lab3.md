...
9. Save, set permissions, and then run that shell script for the application **gedit**. Did it create that report? Try running the script without an argument - What did it do?
